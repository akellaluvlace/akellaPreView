export default function T30ConsultingFirm() {
  ...
  const plates = [
    ...
    { col: "md:col-span-4", aspect: "aspect-square",                                    src: "https://images.unsplash.com/photo-1685787773514-90e8e14af797?q=80&w=900&auto=format&fit=crop",  alt: "Geometric concrete cantilever roofline",            caption: "Plate · No.49 — Civic Hall, Brussels" },
