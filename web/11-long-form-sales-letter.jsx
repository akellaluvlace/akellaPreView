export default function T11LongFormSalesLetter() {
  ...
  const students = [
    ...
    { tag: "No. 04 · Climate Policy", name: "Henrik Sørensen", meta: "$22,000 MRR · corporate seats x 18", img: "https://images.unsplash.com/photo-1492707892479-7bc8d5a4ee93?w=1200&q=85&auto=format&fit=crop", shape: "w-96 aspect-[16/10]" },
  ...
  const workrooms = [
    {
      ...
      img: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=1400&q=85&auto=format&fit=crop",
      alt: "A writer at a long oak desk, morning light, manuscript pages spread out",
      reverse: false,
      kind: "list",
      list: [
    ...
    },
    {
      ...
      alt: "Open notebook with handwritten editorial corrections in red ink",
      reverse: true,
      kind: "quote",
    ...
    },
    {
      ...
      img: "https://images.unsplash.com/photo-1481349518771-20055b2a7b24?w=1400&q=85&auto=format&fit=crop",
      alt: "Stack of bound monograph copies on a stone table",
      reverse: false,
      kind: "specs",
      specs: [
  ...
  return (
    <>
      ...
      <div className="bg-background text-on-background font-body-md antialiased selection:bg-tertiary-fixed selection:text-on-tertiary-fixed">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-stack-md md:gap-stack-lg">
                <div className="md:col-span-5">
                  <figure className="relative aspect-[4/5] rounded bg-tertiary-fixed overflow-hidden border border-outline-variant md:sticky md:top-32">
                    <img alt="Author at a desk fielding reader letters, late afternoon light" className="absolute inset-0 w-full h-full object-cover grayscale-[0.15] contrast-105" src="https://images.unsplash.com/photo-1542038784456-1ea8e935640e?w=1200&q=85&auto=format&fit=crop" />
        ...
        <footer className="bg-[#E8E2D9] dark:bg-stone-900 w-full py-10 border-t border-stone-300 dark:border-stone-700 flex flex-col md:flex-row justify-between items-center px-4 max-w-7xl mx-auto gap-6 mt-12 sm:py-12 sm:px-8 md:px-12">
