export default function T81KineticKino() {
  ...
  const specimens = [
    ...
    { id: "SP_02", title: "Mm", v: 1, meta: "MONO-X · 144pt · OFFSET", w: "w-80", bg: "bg-magenta", textColor: "text-background", chip1: "FACADE", chip1Cls: "bg-primary text-background", tagCls: "bg-background text-magenta", grad: "from-magenta/40 via-transparent to-primary/70", dir: "bl", italic: false, extraImg: "mix-blend-multiply opacity-90", srcOverride: "https://images.unsplash.com/photo-1609530142110-7af0a038c723?w=1000&q=85&auto=format&fit=crop" },
    { id: "SP_03", title: "Ss", v: 3, meta: "SLANT PRO · 96pt · 14°", w: "w-72", bg: "bg-background", textColor: "text-primary", chip1: "SLANT", chip1Cls: "bg-magenta text-background", tagCls: "bg-primary text-background", grad: "from-background via-background/40 to-transparent", dir: "t", italic: true, extraImg: "opacity-90", srcOverride: "https://images.unsplash.com/photo-1601993957728-1e56ab70c5a8?w=900&q=85&auto=format&fit=crop" },
  ...
  const inUseRows = [
    ...
    { side: "right", num: "USE 02 — STAGE", title: "Festival signage at 380pt.", titleV: 1, body: "The Berlin biennial set MONO-X across 240 m² of vinyl. The plotter ran Mono-X axis 200 → 700 between cuts; the line never deviated.", img: "https://images.unsplash.com/photo-1609530142110-7af0a038c723?w=1400&q=85&auto=format&fit=crop", chip: "USE · 02", pill: "BERLIN BIENNIAL", grad: "from-primary/65 via-transparent to-magenta/15", dir: "bl", bullets: ["240 m² · 14 panels", "Cut at 380pt · MONO-X", "12 nights · zero re-set"] },
    { side: "left", num: "USE 03 — INSTITUTION", title: "Wayfinding in the Vault.", titleV: 3, italic: true, body: "Slant Pro at axis 1, weight 200, runs every door label and exhibit caption in the Vault Museum's seven floors. Italics that don't bend the eye.", img: "https://images.unsplash.com/photo-1685787773514-90e8e14af797?w=1400&q=85&auto=format&fit=crop", chip: "USE · 03", pill: "VAULT MUSEUM", grad: "from-primary/55 via-transparent to-transparent", dir: "r", caseLink: "Read the case study →" },
  ];
