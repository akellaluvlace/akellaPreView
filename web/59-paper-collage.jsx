...
const ATELIER_DRAFTS = [
  ...
  { src: "https://images.unsplash.com/photo-1609530142110-7af0a038c723?auto=format&fit=crop&q=80&w=800", thumb: "https://images.unsplash.com/photo-1609530142110-7af0a038c723?auto=format&fit=crop&q=80&w=200", alt: "Archive draft 2", filter: "filter sepia-[0.18] contrast-110", thumbFilter: "filter sepia-[0.18] contrast-110", delay: "6s" },
  ...
  { src: "https://images.unsplash.com/photo-1622912058707-1b33af81db4f?auto=format&fit=crop&q=80&w=800", thumb: "https://images.unsplash.com/photo-1622912058707-1b33af81db4f?auto=format&fit=crop&q=80&w=200", alt: "Archive draft 4", filter: "filter contrast-110 sepia-[0.1]", thumbFilter: "filter contrast-110 sepia-[0.1]", delay: "14s" },
];
            ...
            <div className="lg:col-span-7 order-2 lg:order-1">
              <div className="relative w-full h-[480px] md:h-[560px]">
                ...
                <div className="layered-photo edge-torn-diagonal w-64 md:w-80 h-72 md:h-96 top-12 md:top-16 left-32 md:left-48 transform rotate-2 z-20">
                  <img src="https://images.unsplash.com/photo-1601993957728-1e56ab70c5a8?auto=format&fit=crop&q=80&w=800" className="w-full h-full object-cover filter grayscale contrast-110" alt="Brutalist concrete" />
                </div>
