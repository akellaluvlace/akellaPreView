export default function T99MidcenturyModern() {
  ...
  const collections = [
    ...
    },
    {
      ...
      img: "https://lh3.googleusercontent.com/aida-public/AB6AXuBv43kcsh98td9ebIZHHWaBAMlg8ojH6ZZ2EnYlIfq3hp2BCBEIWmvnbBoJ6f3Gs1wGVCR3WPz2EWxe4Tj8URgO9K3K5VBzyBDnakOHezUuf6ts1tpgBqGzUH9fJ2_2lTHqp6_CHv3R6-WejdwmNMwCrqTlr8iDHD_1jN9JsOhCEoWIUgmjYjqYP8fgn1VmNQlsy1bo1Xh1bVlpQTxYchD4bbUG8eEUjSvcsb1bFQCjazeLnMWC_OXwEFSBIKmBhBJl9O-56fEUKvo",
    },
    {
      ...
      img: "https://lh3.googleusercontent.com/aida-public/AB6AXuCi5xvMITxry999JaIUEGg9hO2VVftFE87us0AAKmzmLV7mHFjBqHy9-CPg_kn9sjf4SoaPFfT2TC5EL32OtGv3-X_bgw3HDLDu4vdPWe11eLWpwKV8bbj5yNeF9camNpjYbY7wCccGpB66oY1XTYdyd1RvQnbaJITJbRoIC6GHoYP9H8ElAsgm80U5YOG8001wcTBO_PgnLWJpvEbrRRICPP15jPCWa2ZhAx9M3rGNLfjTpPrTP9aSQsFlDdRQVvLmbD4cQY6R2gc",
    },
  ];
  ...
  const studioPieces = [
    {
      ...
      img: "https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e?w=1400&q=85&auto=format&fit=crop",
      alt: "Saarinen-style pedestal table in a sunlit room",
      reverse: false,
      specs: [
    ...
    },
    {
      ...
      img: "https://images.unsplash.com/photo-1506439773649-6e0eb8cfb237?w=1400&q=85&auto=format&fit=crop",
      alt: "Wool-upholstered lounge chair in a warm interior",
      reverse: true,
      specs: [
    ...
    },
    {
      ...
      img: "https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e?w=1400&q=85&auto=format&fit=crop&sat=-30",
      alt: "Mid-century credenza with sliding wood doors",
      reverse: false,
      specs: [
  ...
  // Workshop marquee tiles
  const workshopTiles = [
    { w: "w-72 aspect-[3/4]", title: "Pedestal No. 042", meta: "1956 · Teak · Ed. 200", img: "https://images.unsplash.com/photo-1487958449943-2429e8be8625?w=900&q=85&auto=format&fit=crop", alt: "Joinery detail" },
    { w: "w-96 aspect-[16/10]", title: "Hallingdal Lounge", meta: "1962 · Walnut · Open Ed.", img: "https://images.unsplash.com/photo-1517021897933-0e0319cfbc28?w=1200&q=85&auto=format&fit=crop", alt: "Wood grain" },
    { w: "w-72 aspect-[3/4]", title: "Brass Sconce", meta: "1958 · Brass · Ed. 80", img: "https://images.unsplash.com/photo-1611652022419-a9419f74343d?w=900&q=85&auto=format&fit=crop", alt: "Brass hardware" },
    { w: "w-80 aspect-[16/10]", title: "Credenza No. 088", meta: "1959 · Teak · Ed. 150", img: "https://images.unsplash.com/photo-1469041797191-50ace28483c3?w=1200&q=85&auto=format&fit=crop", alt: "Workshop bench" },
    { w: "w-72 aspect-[3/4]", title: "Linen Daybed", meta: "1965 · Oak · Ed. 60", img: "https://images.unsplash.com/photo-1481349518771-20055b2a7b24?w=900&q=85&auto=format&fit=crop", alt: "Linen weave" },
    { w: "w-96 aspect-[16/10]", title: "Atelier Vessel", meta: "1961 · Stoneware · Ed. 30", img: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=1200&q=85&auto=format&fit=crop", alt: "Ceramic vessel" },
    { w: "w-72 aspect-[3/4]", title: "Joiner's Stool", meta: "1957 · Ash · Ed. 120", img: "https://images.unsplash.com/photo-1542038784456-1ea8e935640e?w=900&q=85&auto=format&fit=crop", alt: "Joiners' rasp" },
  ];

  // Process arches
  const processSteps = [
    { numeral: "I", title: "Sketch", body: "Drawn at 1:1, on tracing vellum, in graphite. Each piece begins with a stack of failed lines and one that holds.", season: "Studio · January", img: "https://images.unsplash.com/photo-1542038784456-1ea8e935640e?w=900&q=85&auto=format&fit=crop", alt: "Sketch on paper" },
    { numeral: "II", title: "Joinery", body: "Mortise, tenon, dovetail. No fasteners hidden by stain. Each joint cut by hand and tapped together once, then disassembled, then closed.", season: "Bench · February — April", img: "https://images.unsplash.com/photo-1487958449943-2429e8be8625?w=900&q=85&auto=format&fit=crop", alt: "Joinery in walnut" },
    { numeral: "III", title: "Finish", body: "Linseed, beeswax, time. Three coats minimum, four when the wood asks for it. Signed underneath, then shipped without a card.", season: "Atelier · May", img: "https://images.unsplash.com/photo-1517021897933-0e0319cfbc28?w=900&q=85&auto=format&fit=crop", alt: "Hand-finishing with linseed oil" },
  ];
  ...
  return (
    <>
      ...
      <div className="light bg-[#F5F2ED] dark:bg-[#1A1A1A] text-on-surface antialiased overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
            ...
            <div className="md:col-span-7 relative">
              ...
              <div className="relative w-full aspect-[4/3] bg-surface-variant border border-brand-teak overflow-hidden">
                ...
                <img alt="Teak lounge chair with textured wool cushions" className="w-full h-full object-cover sepia-[.15] contrast-100" src="https://lh3.googleusercontent.com/aida-public/AB6AXuB0Lli1FDcMP9CdjLdbhefeibGmAQI87iq11QmIjyIAL9_mBYOIqQfBXR92vp78W08SGb6kI6BseePrKQAVxMNJFx5zH2XXAjZYgq4b9FoI4t_ITK2GJaeERf976B_1LG5h6pbY1cRzHRbD2UrCWwfcoPQZXyjRmqn9A1eQeW6UBT3jctBMTOAkFiGHU2KdK8OKo2yxecHAz9mD6EQsMDZWK6Fvo1TqQCUllGOjsZ6TDOAtYkYJ9z_5fTPC27PsEhOQk4OeWZ0vgBE" />
              </div>
            </div>
          </div>
        </section>
            ...
            <aside className="md:col-span-5 flex flex-col">
              ...
              <div className="relative mb-8">
                ...
                <figure className="relative w-full aspect-[4/5] border border-brand-teak overflow-hidden bg-surface-variant">
                  <img alt="A teak chair photographed from above in late-afternoon light" className="w-full h-full object-cover sepia-[.18] contrast-105" src="https://images.unsplash.com/photo-1481349518771-20055b2a7b24?w=1200&q=85&auto=format&fit=crop" />
                </figure>
              </div>
        ...
        <section className="full-bleed py-20 md:py-24 overflow-hidden" style={{ backgroundColor: "#ECE3D6" }}>
          <div className="max-w-container-max mx-auto px-4 md:px-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
              <div className="md:col-span-7 divide-y divide-brand-teak/20 border-t border-b border-brand-teak/20">
                {faqs.map((f, i) => (
        ...
        <footer className="bg-[#2D2926] dark:bg-[#0F0F0F] border-t-4 border-[#D95D39] mt-24">
