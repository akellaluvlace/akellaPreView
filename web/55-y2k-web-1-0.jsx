            ...
            <aside className="w-full md:w-64 flex flex-col gap-3 shrink-0">
              ...
              <div className="bevel-outset p-2 bg-winGray">
                ...
                <div className="border-2 border-winDarkGray bg-black overflow-hidden relative">
                  <img src="https://images.unsplash.com/photo-1776275758873-31603dd06112?auto=format&fit=crop&w=400&q=70" alt="Pin-up of the week" className="w-full aspect-[3/4] object-cover saturate-200 contrast-125 hue-rotate-[280deg] mix-blend-screen" />
          ...
          <section className="bevel-inset bg-winGray mx-1 mb-2 p-3">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-2">
              ...
              <div className="relative aspect-square overflow-hidden bevel-outset bg-winGray">
                ...
                <img className="absolute top-2 left-2 w-3/5 h-3/5 object-cover -rotate-3 border-2 border-white shadow-md" src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=300&q=70" alt="" loading="lazy" />
              ...
              <div className="relative aspect-square overflow-hidden bevel-outset bg-winGray">
                ...
                <img className="absolute top-2 left-2 w-3/5 h-3/5 object-cover rotate-2 border-2 border-white shadow-md" src="https://images.unsplash.com/photo-1767175620484-1ed37931a0d1?auto=format&fit=crop&w=300&q=70" alt="" loading="lazy" />
                <span className="absolute bottom-1 right-1 bg-winBlue text-white text-[9px] font-pixel px-1 py-0.5">★ FRIEND</span>
              </div>
              ...
              <div className="relative aspect-square overflow-hidden bevel-outset bg-winGray">
                ...
                <img className="absolute top-2 left-2 w-3/5 h-3/5 object-cover rotate-3 border-2 border-white shadow-md" src="https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?auto=format&fit=crop&w=300&q=70" alt="" loading="lazy" />
                <span className="absolute bottom-1 right-1 bg-winBlue text-white text-[9px] font-pixel px-1 py-0.5">★ FRIEND</span>
              </div>
              ...
              <div className="relative aspect-square overflow-hidden bevel-outset bg-winGray">
                ...
                <img className="absolute top-2 left-2 w-3/5 h-3/5 object-cover -rotate-3 border-2 border-white shadow-md" src="https://images.unsplash.com/photo-1776275758873-31603dd06112?auto=format&fit=crop&w=300&q=70" alt="" loading="lazy" />
                <span className="absolute bottom-1 right-1 bg-winBlue text-white text-[9px] font-pixel px-1 py-0.5">★ FRIEND</span>
              </div>
              ...
              <div className="relative aspect-square overflow-hidden bevel-outset bg-winGray">
                ...
                <img className="absolute top-2 left-2 w-3/5 h-3/5 object-cover rotate-2 border-2 border-white shadow-md" src="https://images.unsplash.com/photo-1758600587391-338f5376b7ed?auto=format&fit=crop&w=300&q=70" alt="" loading="lazy" />
                <span className="absolute bottom-1 right-1 bg-winBlue text-white text-[9px] font-pixel px-1 py-0.5">★ FRIEND</span>
              </div>
              ...
              <div className="relative aspect-square overflow-hidden bevel-outset bg-winGray">
                ...
                <img className="absolute top-2 left-2 w-3/5 h-3/5 object-cover -rotate-1 border-2 border-white shadow-md" src="https://images.unsplash.com/photo-1701096374092-bb70915fdc5c?auto=format&fit=crop&w=300&q=70" alt="" loading="lazy" />
                <span className="absolute bottom-1 right-1 bg-winBlue text-white text-[9px] font-pixel px-1 py-0.5">★ FRIEND</span>
              </div>
              ...
              <div className="relative aspect-square overflow-hidden bevel-outset bg-winGray">
                ...
                <img className="absolute top-2 left-2 w-3/5 h-3/5 object-cover rotate-3 border-2 border-white shadow-md" src="https://images.unsplash.com/photo-1762341124796-530c0085f7d8?auto=format&fit=crop&w=300&q=70" alt="" loading="lazy" />
                <span className="absolute bottom-1 right-1 bg-winBlue text-white text-[9px] font-pixel px-1 py-0.5">★ FRIEND</span>
              </div>
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="md:w-1/3 shrink-0">
                <div className="md:sticky md:top-4 bevel-outset bg-white p-2">
                  <img src="https://images.unsplash.com/photo-1762341124796-530c0085f7d8?auto=format&fit=crop&w=600&q=70" alt="Webmaster portrait" className="w-full aspect-[3/4] object-cover saturate-150 contrast-110 hue-rotate-[200deg]" loading="lazy" />
