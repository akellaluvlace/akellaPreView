export default function T112CrtGlitchCyber() {
  ...
  const relicsBottom = [
    ...
    { id: "RELIC_008", label: "B/W",     treatment: "bw",      src: "https://images.unsplash.com/photo-1581090700227-1e37b190418e?q=80&w=900&auto=format&fit=crop", alt: "Server uplink hardware, B&W" },
  ];
  ...
  const transmissions = [
    ...
    { label: "> FORGE COMPILED",    date: "2024.11.19 · 09:33", cardCls: cyanCard,    imgBorder: cyanImg,    textColor: "text-primary-fixed",     scan: false, imgClass: "saturate-150 hue-rotate-[170deg]", src: "https://images.unsplash.com/photo-1581090700227-1e37b190418e?q=80&w=200&auto=format&fit=crop", alt: "Server uplink hardware" },
