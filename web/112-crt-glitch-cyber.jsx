export default function T112CrtGlitchCyber() {
  ...
  const relicsBottom = [
    { id: "RELIC_005", label: "MAGENTA", treatment: "magenta", src: "https://images.unsplash.com/photo-1531259683007-016a7b628fc3?q=80&w=900&auto=format&fit=crop", alt: "Industrial machinery, magenta tint" },
    ...
    { id: "RELIC_007", label: "MAGENTA", treatment: "magenta", src: "https://images.unsplash.com/photo-1551808525-51a94da548ce?q=80&w=900&auto=format&fit=crop", alt: "Wide server-room shot, magenta tint" },
    { id: "RELIC_008", label: "B/W",     treatment: "bw",      src: "https://images.unsplash.com/photo-1611652022419-a9419f74343d?q=80&w=900&auto=format&fit=crop", alt: "Brass apothecary objects, B&W" },
  ];
  ...
  const transmissions = [
    ...
    { label: "> RELAY_142 OPEN",    date: "2024.11.21 · 22:08", cardCls: magentaCard, imgBorder: magentaImg, textColor: "text-secondary",          scan: false, imgClass: "saturate-150 hue-rotate-[290deg]", src: "https://images.unsplash.com/photo-1531259683007-016a7b628fc3?q=80&w=200&auto=format&fit=crop", alt: "Industrial machinery" },
    ...
    { label: "> FORGE COMPILED",    date: "2024.11.19 · 09:33", cardCls: cyanCard,    imgBorder: cyanImg,    textColor: "text-primary-fixed",     scan: false, imgClass: "saturate-150 hue-rotate-[170deg]", src: "https://images.unsplash.com/photo-1611652022419-a9419f74343d?q=80&w=200&auto=format&fit=crop", alt: "Brass apothecary objects" },
    ...
    { label: "> UPLINK STABLE",     date: "2024.11.17 · 11:03", cardCls: amberCard,   imgBorder: amberImg,   textColor: "text-tertiary-fixed-dim", scan: false, imgClass: "saturate-150 hue-rotate-[290deg]", src: "https://images.unsplash.com/photo-1551808525-51a94da548ce?q=80&w=200&auto=format&fit=crop", alt: "Wide server room" },
  ...
  return (
    <>
      ...
      <div className="dark bg-background text-on-background min-h-screen font-body-md overflow-x-hidden selection:bg-primary-container selection:text-on-primary-container">
        ...
        <section className="p-margin relative min-h-[512px] flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0 opacity-10" style={{ backgroundImage: "linear-gradient(30deg, #5b005b 12%, transparent 12.5%, transparent 87%, #5b005b 87.5%, #5b005b), linear-gradient(150deg, #5b005b 12%, transparent 12.5%, transparent 87%, #5b005b 87.5%, #5b005b), linear-gradient(30deg, #5b005b 12%, transparent 12.5%, transparent 87%, #5b005b 87.5%, #5b005b), linear-gradient(150deg, #5b005b 12%, transparent 12.5%, transparent 87%, #5b005b 87.5%, #5b005b), linear-gradient(60deg, #380038 25%, transparent 25.5%, transparent 75%, #380038 75%, #380038), linear-gradient(60deg, #380038 25%, transparent 25.5%, transparent 75%, #380038 75%, #380038)", backgroundSize: "40px 70px", backgroundPosition: "0 0, 0 0, 20px 35px, 20px 35px, 0 0, 20px 35px" }} />
          <div className="relative z-10 text-center flex flex-col items-center">
            <h2 className="font-headline-lg text-on-surface mb-8 bg-background/80 px-4 py-2 border border-outline-variant inline-block">COMMENCE THE RITUAL</h2>
            <button className="w-48 h-48 rounded-full bg-error-container border-8 border-surface-container relative shadow-[0_20px_50px_rgba(255,0,0,0.3),inset_0_5px_15px_rgba(255,255,255,0.2)] flex items-center justify-center group active:transform active:translate-y-2 active:shadow-[0_5px_10px_rgba(255,0,0,0.3),inset_0_2px_5px_rgba(0,0,0,0.5)] transition-all duration-150">
