    ...
    "steps": 5
            ...
            <section id="themes" className="mt-stack_lg pt-stack_lg border-t border-outline-variant/40" aria-labelledby="themes-heading">
              ...
              <div className="relative overflow-hidden -mx-8 px-1 py-2">
                ...
                <div className="doc-marquee-track px-8">
                  {[
                    { id: "1609530142110-7af0a038c723", name: "Venice Bank", code: "venice_bank", strategy: "linear-cool", tokens: 5, swatches: ["#0F1A4D","#3B4FA9","#7E92E0","#C9D2F2","#F4F6FB"], wash: "linear-gradient(135deg, rgba(108,92,231,0.55) 0%, rgba(83,65,205,0.30) 50%, rgba(0,0,0,0.45) 100%)" },
                    ...
                    { id: "1601993957728-1e56ab70c5a8", name: "Atrium Health", code: "atrium_health", strategy: "complementary", tokens: 6, swatches: ["#053C3A","#0E6B66","#3FB1A6","#9EE0D7","#E6F6F2"], wash: "linear-gradient(135deg, rgba(50,180,160,0.55) 0%, rgba(7,103,99,0.35) 55%, rgba(0,0,0,0.40) 100%)" },
                    ...
                    { id: "1685787773514-90e8e14af797", name: "North Aperture", code: "north_aperture", strategy: "grayscale-tuned", tokens: 8, swatches: ["#0B0C0F","#1E2128","#3A3F4A","#838B9C","#D7DBE3"], wash: "linear-gradient(135deg, rgba(60,60,72,0.45) 0%, rgba(28,27,35,0.45) 60%, rgba(0,0,0,0.55) 100%)" },
            ...
            <section id="gallery" className="mt-stack_lg pt-stack_lg border-t border-outline-variant/40 mb-stack_lg" aria-labelledby="gallery-heading">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3">
                {[
                  { src: "1609530142110-7af0a038c723", code: "venice_bank",   wash: "linear-gradient(135deg, rgba(108,92,231,0.55) 0%, rgba(83,65,205,0.30) 50%, rgba(0,0,0,0.45) 100%)" },
                  ...
                  { src: "1685787773514-90e8e14af797", code: "north_aperture",wash: "linear-gradient(135deg, rgba(60,60,72,0.45) 0%, rgba(28,27,35,0.45) 60%, rgba(0,0,0,0.55) 100%)" },
                  ...
                  { src: "1622912058707-1b33af81db4f", code: "halberd_oil",   wash: "linear-gradient(135deg, rgba(15,140,180,0.50) 0%, rgba(7,90,130,0.35) 60%, rgba(0,0,0,0.45) 100%)" },
