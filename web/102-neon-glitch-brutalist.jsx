export default function T102NeonGlitchBrutalist() {
  ...
  const cyanFeedTiles = [
    ...
    { tag: "SITE_03", meta: "— DECODED", w: "w-80", aspect: "aspect-[16/10]", overlay: "radial-gradient(ellipse at 30% 40%, rgba(34,211,238,0.35) 0%, transparent 65%)", blend: "mix-blend-screen", src: "https://images.unsplash.com/photo-1609530142110-7af0a038c723?w=1000&q=85&auto=format&fit=crop", alt: "brutalist architecture cyan tinted", shadow: false, gray: true },
  ];
  const magentaFeedTiles = [
    ...
    { tag: "SITE_M", meta: "— DECRYPTED", w: "w-80", aspect: "aspect-[16/10]", overlay: "radial-gradient(ellipse at 70% 40%, rgba(232,121,249,0.40) 0%, transparent 65%)", blend: "mix-blend-screen", src: "https://images.unsplash.com/photo-1609530142110-7af0a038c723?w=1000&q=85&auto=format&fit=crop", alt: "brutalist architecture magenta tinted", shadow: false, gray: true },
  ];
  const bootSteps = [
        ...
        <main className="relative w-full z-10 px-gutter pb-margin">
          ...
          <section className="grid grid-cols-1 md:grid-cols-12 gap-unit mb-margin">
            ...
            <div className="col-span-1 md:col-span-4 relative border-2 border-white p-8 flex flex-col justify-between min-h-[400px] overflow-hidden bg-black">
              <img alt="" aria-hidden="true" className="absolute inset-0 w-full h-full object-cover grayscale contrast-150 opacity-30" style={{ filter: "hue-rotate(170deg) saturate(1.6) contrast(1.4)" }} src="https://images.unsplash.com/photo-1609530142110-7af0a038c723?w=1200&q=85&auto=format&fit=crop" />
          ...
          <section className="mb-margin border-t-2 border-white pt-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-unit">
              <div className="md:col-span-4 relative border-2 border-white overflow-hidden bg-black aspect-square md:aspect-auto md:min-h-[420px]">
                <img alt="brutalist architecture tinted cyan FAQ side panel" className="absolute inset-0 w-full h-full object-cover grayscale" style={{ filter: "hue-rotate(170deg) saturate(1.5) contrast(1.4)" }} src="https://images.unsplash.com/photo-1609530142110-7af0a038c723?w=900&q=85&auto=format&fit=crop" />
