export default function T64Isometric() {
  ...
  const edgeNodes = [
    ...
    { id: "NODE_31", region: "SA-EAST", city: "São Paulo · 22ms", racks: "19 racks", img: "https://images.unsplash.com/photo-1609530142110-7af0a038c723?w=900&q=85&auto=format&fit=crop", w: "w-72", grad: "from-slate-900 via-transparent to-brand-700/20", dir: "tr", status: "ONLINE", statusColor: "text-green-400", live: true, racksColor: "text-brand-400" },
    { id: "NODE_44", region: "AU-CENTRAL", city: "Sydney · 28ms", racks: "+8 racks", img: "https://images.unsplash.com/photo-1601993957728-1e56ab70c5a8?w=1000&q=85&auto=format&fit=crop", w: "w-80", grad: "from-slate-900/40 via-transparent to-slate-900", dir: "bl", status: "SCALING", statusColor: "text-blue-400", live: false, racksColor: "text-brand-400" },
    ...
    { id: "NODE_61", region: "ME-CENTRAL", city: "Dubai · 19ms", racks: "22 racks", img: "https://images.unsplash.com/photo-1685787773514-90e8e14af797?w=1000&q=85&auto=format&fit=crop", w: "w-80", grad: "from-slate-900 via-transparent to-brand-700/25", dir: "tr", status: "ONLINE", statusColor: "text-green-400", live: true, racksColor: "text-brand-400" },
  ];
