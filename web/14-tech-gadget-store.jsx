const catalogTiles = [
  ...
  { code: "CCX-031 · CHASSIS", alt: "brushed alloy chassis render with directional studio light", src: "https://images.unsplash.com/photo-1624687209016-fa523a65b04e?w=400&q=70&auto=format&fit=crop" },
  { code: "CCX-040 · NODE", alt: "abstract render of a compute node with cool ambient lighting", src: "https://images.unsplash.com/photo-1579567761406-4684ee0c75b6?w=400&q=70&auto=format&fit=crop" },
  ...
  { code: "CCX-108 · ANTENNA", alt: "abstract glowing geometric sphere render — antenna emitter reference", src: "https://images.unsplash.com/photo-1625014618427-fbc980b974f5?w=400&q=70&auto=format&fit=crop" },
  ...
  { code: "CCX-129 · POWER-CELL", alt: "vintage tech product render with detailed depth of field", src: "https://images.unsplash.com/photo-1668137307106-7ea329e251cd?w=400&q=70&auto=format&fit=crop" },
  { code: "CCX-136 · SHIELD-AL", alt: "abstract hovering enclosure render with mechanical detail", src: "https://images.unsplash.com/photo-1641799185120-184619b22895?w=400&q=70&auto=format&fit=crop" },
          ...
          <section className="max-w-container-max mx-auto px-4 py-10 mt-10 sm:px-6 sm:py-16 sm:mt-margin md:px-margin md:py-margin overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-stack-lg items-center">
              ...
              <div className="relative aspect-[4/3] lg:aspect-auto lg:h-[480px] mr-[calc(50%-50vw)] bg-surface-container border-l border-y border-outline-variant overflow-hidden">
                <img alt="server room corridor with parallel racks and cool blue indicator lights stretching into the distance" className="absolute inset-0 w-full h-full object-cover mix-blend-luminosity" src="https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=1600&q=80&auto=format&fit=crop" />
